...
action_7 (7) = happyGoto action_25
...
action_8 (21) = happyShift action_20
...
action_23 (11) = happyGoto action_12
action_23 (12) = happyGoto action_13
...
action_24 (14) = happyGoto action_28
...
action_27 (32) = happyShift action_43
...
action_30 (30) = happyShift action_41
...
action_40 (9) = happyGoto action_11
action_40 (11) = happyGoto action_12
action_40 (12) = happyGoto action_13
...
happyReduction_5 (_ `HappyStk`
	...
	happyRest)
	 = HappyAbsSyn6
		 (Setting happy_var_1 happy_var_3
	) `HappyStk` happyRest
...
happyReduction_14 (HappyTerminal (TokenInt happy_var_1))
	 =  HappyAbsSyn9
		 (ScalarInt happy_var_1
	)
happyReduction_14 _  = notHappyAtAll 

happyReduce_15 = happySpecReduce_1  9 happyReduction_15
happyReduction_15 (HappyTerminal (TokenInt64 happy_var_1))
	 =  HappyAbsSyn9
		 (ScalarInt happy_var_1
	)
...
happyReduction_16 (HappyTerminal (TokenHex happy_var_1))
	 =  HappyAbsSyn9
		 (ScalarInt happy_var_1
	)
...
happyReduction_17 (HappyTerminal (TokenHex64 happy_var_1))
	 =  HappyAbsSyn9
		 (ScalarInt happy_var_1
	)
...
happyReduction_18 (HappyTerminal (TokenFloat happy_var_1))
	 =  HappyAbsSyn9
		 (ScalarFloat happy_var_1
	)
happyReduction_18 _  = notHappyAtAll 

happyReduce_19 = happySpecReduce_1  9 happyReduction_19
happyReduction_19 (HappyTerminal (TokenString happy_var_1))
	 =  HappyAbsSyn9
		 (ScalarString happy_var_1
	)
...
happyNewToken action sts stk (tk:tks) =
	...
	TokenInt64 happy_dollar_dollar -> cont 18;
	TokenHex happy_dollar_dollar -> cont 19;
	TokenHex64 happy_dollar_dollar -> cont 20;
	TokenFloat happy_dollar_dollar -> cont 21;
...
configParse tks = happyRunIdentity happySomeParser where
